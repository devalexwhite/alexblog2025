---
title: Discovering New Music Through Internet Radio
tags: posts
layout: article.njk
date: 2025-12-03T12:13:01Z
---

This is the first post in my series of articles on taking back ownership in your relationship with technology. Learn the idea behind this series in my [initial post](https://thatalexguy.dev/posts/dont-lose-it-reuse-it/).
...
Internet Radio is nothing new, in fact it's been around far longer than Spotify or Pandora, starting with ["Internet Talk Radio" in 1993](https://en.wikipedia.org/wiki/Internet_radio#History). Today it's less popular, but still very much alive. While there are paid platforms, such as Sirius XM (now streamed via internet rather than satellite), there are also thousands of free, independent stations to discover.
...
- [Radio Garden](https://radio.garden/search) - Web based, free
- [Transistor - Simple Radio App](https://f-droid.org/en/packages/org.y20k.transistor/) - Android, free, open-source
- [Shortwave](https://apps.gnome.org/Shortwave/) - Linux (GTK), free, open-source, **top pick**
- [Broadcasts](https://apps.apple.com/us/app/broadcasts/id1469995354) - Mac OS/iPhone, paid
...
- [Recommended Radio Streams by deroverda](https://github.com/deroverda/recommended-radio-streams)
- [Radio Garden](https://radio.garden/search) (mentioning again, it's great for discovering local stations) 
...
[Bob Rathbone - Raspberry Pi Internet Radio](https://www.bobrathbone.com/raspberrypi/pi_internet_radio.html)
...
![Screenshot of Shortwave App](/posts/alternative-guides/internet-radio/shortwave-screenshot.webp)

---

If you found this article helpful, or have suggestions on tools/stations/etc, send me an email at [hi@thatalexguy.dev](mailto:hi@thatalexguy.dev)